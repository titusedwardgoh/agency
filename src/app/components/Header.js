  ...
  return (
    <header className="relative">
      ...
      <div className="fixed top-0 left-0 w-full z-50 bg-primary">
        <div className="max-w-[1700px] mx-auto flex justify-between items-center p-5 px-10 md:py-5">
          <Link href="/">
            <Image
              src="/logo.svg"
              width={100}
          ...
          <nav className="hidden md:flex gap-7 text-secondary font-bold text-lg lg:text-xl">
            ...
            <Link
              href="/work"
              className={`cursor-pointer hover:underline hover:decoration-2 hover:underline-offset-4 ${
                pathname === "/work" ? "underline decoration-2 underline-offset-4" : ""
              }`}
            >
              Work
            </Link>
      ...
      <ul
        className={`md:hidden fixed top-[72px] left-0 w-full z-40 bg-primary flex flex-col transition-all duration-300 ease-in-out ${
          showMenu
