...
export default function Reviews() {
  ...
  return (
    ...
    <div className="relative w-full bg-primary text-secondary flex items-center overflow-hidden" style={{ maxWidth: "100%" }}>
      <div
      ...
      >
        {slides.map((review, index) => (
          ...
          >
            <p className="text-lg mb-2 font-bold max-w-xl leading-relaxed mx-auto lg:mx-0 lg:text-4xl">
              {review.review}
            </p>
            <div className="pt-7 ">
